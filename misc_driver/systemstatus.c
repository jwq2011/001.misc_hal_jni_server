...
#elif (define READ_FROM_MMC_REGISTER)
...
//			copy_to_user(value, arg, sizeof(value));
			break;
		case IOCTL_ANDROID_SET_BOOTCONFIG:
			memset(mBuffer,0, sizeof(mBuffer));
			copy_from_user(mBuffer, arg, sizeof(mBuffer));
